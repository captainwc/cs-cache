---
title: 常用数学符号的latex表示(markdown)
index_img: /img/banner/27.jpg
tags: markdown
categories: 知识总结
---
...
<b>极限</b>：`\displaystyle \lim_{x_\to \infty}{\frac{3x^2+2}{4x^2+3x+1}}` `\lim`

$$
\displaystyle\lim_{x_\to \infty}{\frac{3x^2+2}{4x^2+3x+1}}\tag{1}
$$

<b>积分</b>：`\displaystyle \int_{0}^{\pi}{(sinx+cosx)dx}` `\int`

$$
\displaystyle\int_{0}^{\pi}{(sinx+cosx)dx}\tag{2}
$$

**求和**：`\displaystyle\sum_{i=0}^n{i^2+i}` `\sum`

$$
\displaystyle\sum_{i=0}^n{i^2+i}\tag{3}
$$

**开方**：`\sqrt[3]{x^2+3x}` `\sqrt`

$$
\sqrt[3]{x^2+3x}\tag{4}
$$

**矩阵**：`\left(\begin{matrix}&1&2&\cdots&5\\&6&7&\cdots&10\\&\vdots&\vdots&\ddots&\vdots\\&16&17&\cdots&20\end{matrix}\right)` `( \begin{matrix}& & &\\& & & \end{martix} )`

$$
\left(\begin{matrix}&1&2&\cdots&5\\&6&7&\cdots&10\\&\vdots&\vdots&\ddots&\vdots\\&16&17&\cdots&20\end{matrix}\right)\tag{5}
$$
...
5. $\left(\frac{x}{y}\right)$$\Big(\frac{x}{y}\Big)$
6. 组合公式，符号：`{上位公式 \choose 下位公式}`，如：${n+1 \choose k}={n \choose k}+{n \choose k-1}$
7. 组合公式，符号：`{上位公式 \atop 下位公式}`，如：$\sum_{k_0,k_1,\ldots>0 \atop k_0+k_1+\cdots=n}A_{k_0}A_{k_1}\cdots$
8. $\atop a$
...
7. 求和运算，符号：`\sum`，如：$\displaystyle \sum^{x \to \infty}_{y \to 0}{\frac{x}{y}}$
8. 求和运算，符号：`\displaystyle \sum`，如：$\displaystyle \sum^{x \to \infty}_{y \to 0}{\frac{x}{y}}$
9. 积分运算，符号：`\int`，如：$\displaystyle\int^{\infty}_{0}{xdx}$
10. 积分运算，符号：`\displaystyle \int`，如：$\displaystyle \int^{\infty}_{0}{xdx}$
11. 微分运算，符号：`\partial`，如：$\frac{\partial x}{\partial y}$
12. 矩阵表示，符号：`\begin{matrix} \end{matrix}`，如：$\left[ \begin{matrix} 1 &2 &\cdots &4 &5 &6 &\cdots &8\\\vdots &\vdots &\ddots &12&13 &14 &\cdots &16\end{matrix} \right]$
